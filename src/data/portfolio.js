...
const skills = {
  ...
  mySkills: [
    ...
    },
    {
      ...
      skills: ["vLLM", "CrewAI", "LangGraph", "LangChain", "Hugging Face Transformers", "PyTorch", "TensorFlow", "Keras", "Scikit-learn", "YOLO", "Kafka", "Redis", "MongoDB", "PostgreSQL", "Neo4j", "Milvus", "ChromaDB", "AWS (S3)", "FastAPI", "Flask", "SQLAlchemy", "Playwright", "Selenium", "BeautifulSoup", "Retool", "Power BI", "Tableau"],
    },
    /*
    {
      title: "Others",
