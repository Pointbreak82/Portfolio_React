  ...
  experiences: [
    {  
      ...
      description: ["Object Detection Pipeline: Developed a YOLO-based pipeline for object detection in video frames, enabling keyword-based clip generation and summary creation enhancing content analysis and annotation",
          ...
          "DataProcessing & Analysis Pipelines: Designed and optimized data pipelines using Python, MongoDB, and FastAPI, enhancing data handling and reporting efficiency. Applied data analysis and visualization techniques to generate insights, improving reporting accuracy.",
